...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    **MJAAR-4 & MJAAR-37 do not have acceptance criteria**
...
**Commits should start with the branch name**
...
**MJAAR-4 not marked as complete**
...
Frontend documentation is a good start, but I don't find it particularly useful to have a file of all "docstrings" for components.

For backend documentation, consider using Swagger. It integrates very nicely, generating documents from endpoint headers.
