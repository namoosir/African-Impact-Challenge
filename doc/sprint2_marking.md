...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1
    Feedback: MJAAR-69, MJAAR-79 does not entirely follow the user story template. Please remember to follow the template (As a ___, I want to ____, so that _____)  
